      ...
      {activeTab === 'form' && (
        <div className="rounded-2xl border border-[#262636] bg-[#14141E] p-7 shadow-sm">
          ...
          <form className="grid grid-cols-12 gap-5" onSubmit={handleSubmit(save)}>
            ...
            <div className="col-span-4"><label className={labelClass}>Status</label><select className={inputClass} {...register('status')}><option value="draft">Draft</option><option value="published">Published</option></select></div>
